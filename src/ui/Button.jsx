...
function Button({ children, disabled, to, type, onClick }) {
    ...
    const styles = {
        ...
        secondary: `
            border-2 border-stone-300 uppercase font-semibold 
            ...
            focus:bg-stone-300 focus:outline-none focus:ring focus:text-stone-800
            focus:ring-stone-200 focus:ring-offset-2 text-sm
